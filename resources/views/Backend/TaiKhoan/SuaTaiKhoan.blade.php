    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li><i class="fa fa-file-text-o"></i>Sửa tài khoản</li>
        </ol>
      </div>
    </div>
    <div class="row">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" id="chucvu">
                          <option @if($data->chucvu == 1) selected @endif value="1">Thành viên</option>
                          <option @if($data->chucvu == 2) selected @endif value="2">Quản trị viên</option>
                      </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input id="masv" type="text" class="form-control" value="{{ $data->masv }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Lớp Khoa</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="lopkhoa" value="{{ $data->lopkhoa }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Email/ Số điện thoại*</label>
                    <div class="col-sm-10">
                      <input disabled="" type="text" class="form-control" id="email" value="{{ $data->email }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"><button id="submit" type="button" class="btn btn-primary">Sửa tài khoản</button></div>
                </div>
              </div>
            </div>
            </section>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div>
                ...
                <span class="modal-content-custom">Cập nhật tài khoản thành công</span>
            </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div>
                ...
                <span class="modal-content-custom">Cập nhật tài khoản thất bại</span>
            </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
